...
public class DriveTrain {
    ...
    public void driveTrainByControls() {
        ...
        if (isDriverControlEnabled) {
            ...
            if(direction){
                mecanumDrive.driveCartesian(driveSpeedCoefficient * ySpeed * ySpeed * yDirectionMaintainer, (driveSpeedCoefficient + 0.2) * -xSpeed * xSpeed * xDirectionMaintainer,
                (driveSpeedCoefficient - 0.2) * zSpeed * zSpeed * zDirectionMaintainer); // shooter is front
            } else {
                mecanumDrive.driveCartesian(driveSpeedCoefficient * -ySpeed * ySpeed * yDirectionMaintainer, (driveSpeedCoefficient + 0.2) * xSpeed * xSpeed * xDirectionMaintainer,
                (driveSpeedCoefficient - 0.2) * zSpeed * zSpeed * zDirectionMaintainer); // intake is front
            }
